...
namespace MyPacketCapturer
{
    public partial class frmSend : Form
    {
        ...
        public int[] ipaddressListen = { 0, 0, 0, 0 };
        //string arraycombine;
        ...
        */
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox4.Text != "")
            {
                ...
                string[] ipaddressListenString = { "0", "0", "0", "0" };
                ipaddressListenString = textBox4.Text.Split(' ', '.');
                Debug.Write("The Listen IP is: ");
                int j = 0;
                foreach (string w in ipaddressListenString)
                {
                    ipaddressListen[j] = Int32.Parse(ipaddressListenString[j]);
                    i++;
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] ipaddressListenString = { "0", "0", "0", "0" };
                ipaddressListenString = textBox5.Text.Split(' ', '.');
                Debug.Write("The Listen IP is: ");
                ...
                foreach (string w in ipaddressListenString)
                {
                    ipaddressListen[i] =  Int32.Parse(ipaddressListenString[i]);
                    i++;
                }
            }
            int j=0;
            foreach (int w in ipaddressListen)
                {
                   Debug.WriteLine(w);
                    j++;
                }
